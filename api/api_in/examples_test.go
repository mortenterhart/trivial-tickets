...
// Example CreateNewTicket explains how to create
// a new ticket using a JSON e-mail sent to the ReceiveMail
// handler.
...
// Example CreateNewAnswer shows which steps are
// necessary to create a new answer to an existing ticket
// out of a JSON mail.
