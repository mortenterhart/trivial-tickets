...
// sessionCookieName is the used name for the
// session cookie.
const sessionCookieName = "session"

// sessionCookieTTL is the used time to live for
// the session cookie.
const sessionCookieTTL = 3600
...
func GetSessionID(r *http.Request) string {
	...
	userCookie, errUserCookie := r.Cookie(sessionCookieName)
