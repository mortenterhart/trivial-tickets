...
func TestDebug(t *testing.T) {
	...
	t.Run(testBufferContainsLogLevel, func(t *testing.T) {
		assert.Contains(t, testLogger.String(), testDebugLogLevel, "test buffer should contain TEST DEBUG log level")
	})
...
func TestDebugf(t *testing.T) {
	...
	arguments := []interface{}{"/api/receive", "POST", "localhost:8443", "application/json", 30}
...
func TestBeginTest(t *testing.T) {
	...
	t.Run("bufferContainsFunctionName", func(t *testing.T) {
		assert.Contains(t, testLogger.String(), "testlogger.TestBeginTest", "the test buffer should contain the package and function name")
	})

	t.Run("bufferContainsTestFilename", func(t *testing.T) {
		assert.Contains(t, testLogger.String(), "testlogger_test.go")
	})
}
...
func TestEndTest(t *testing.T) {
	...
	t.Run("bufferContainsFunctionName", func(t *testing.T) {
		assert.Contains(t, testLogger.String(), "testlogger.TestEndTest", "the test buffer should contain the package and function name")
	})
